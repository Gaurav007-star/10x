...
const Hero = () => {
  return (
    <Element name="hero">
      <div className="w-full h-max flex flex-col items-center justify-center pb-10">
        {/* heading-section */}
        <div className="heading w-full h-max z-50 flex flex-col items-center justify-center mt-20 mb-10">
          <BoxReveal boxColor={"#3b82f6"} duration={0.7}>
            <h1 className="text-left text-[12vh] font-serif font-bold leading-[70px] w-full bg-linear-to-r from-[#89c9f3] to-primary bg-clip-text text-transparent">
              Centre of Excellence for
            </h1>
          </BoxReveal>

          <BoxReveal boxColor={"#3b82f6"} duration={1}>
            <h2 className="text-[100px] text-secondary-foreground font-semibold">
              AI in Education.
            </h2>
          </BoxReveal>
        </div>
        ...
        <div className="image-background-section relative w-full h-max flex items-center justify-center p-5">
          ...
          <img
            src={background}
            alt="background"
            className="w-[75vw] h-fit rounded-4xl bg-cover bg-center shadow-lg cursor-pointer duration-200 transition-transform z-20"
          />
        </div>

        {/* vision-mission-section */}
        <div className="vision-mission w-full h-max flex items-center justify-between text-primary px-[10vw] py-10 cursor-pointer">
          {/* left-VISION-section */}
