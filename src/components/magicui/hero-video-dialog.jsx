        ...
        {isVideoOpen && (
          ...
          >
            <motion.div
              ...
              className="relative w-screen h-screen sm:w-[60vw] sm:h-[100vh] mx-auto"
              onClick={(e) => e.stopPropagation()}
            >
              <motion.button
                className="absolute top-4 right-4 z-10 rounded-full bg-neutral-900/50 p-2 text-xl text-white ring-1 backdrop-blur-md dark:bg-neutral-100/50 dark:text-black"
                onClick={() => setIsVideoOpen(false)}
              >
